...
public class PurchasesGraphElement implements GraphElement {
	...
	private static final String visibleSetting = SettingsManager.DASHBOARD_GRAPH_PURCHASES_VISIBLE;

	private final SettingsManager settingsManager;
	private final Map<Integer, Double> data;
	private boolean isVisible;
	
	public PurchasesGraphElement(SettingsManager settingsManager) {
